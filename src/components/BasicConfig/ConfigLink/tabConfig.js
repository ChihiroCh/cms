...
//   const { effectiveType, effectiveStartTime, effectiveEndTime, effectiveDay } =
//     row;
//   if (effectiveType === 2) {
//     let s = effectiveStartTime
//       ? dayjs(effectiveStartTime).format('YYYY-MM-DD hh:mm:ss')
//       : '';
//     let e = effectiveEndTime
//       ? dayjs(effectiveEndTime).format('YYYY-MM-DD hh:mm:ss')
//       : '';
//     return `${s}至${e}`;
//   } else {
...
//   let s = row.activityStartTime
//     ? dayjs(row.activityStartTime).format('YYYY-MM-DD hh:mm:ss')
//     : '';
//   let e = row.activityEndTime
//     ? dayjs(row.activityEndTime).format('YYYY-MM-DD hh:mm:ss')
//     : '';
//   return `${s}至${e}`;
// };
// 状态格式化
